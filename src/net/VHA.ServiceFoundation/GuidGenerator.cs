...
namespace VHA.ServiceFoundation
{
    ...
    public static class GuidGenerator
    {
        ...
        private static DateTimeOffset _lastTimestampForNoDuplicatesGeneration = DateTimePrecise.UtcNowOffset;
        ...
        public static Guid GenerateTimeBasedGuid()
        {
            switch (GuidGeneration)
            {
                case GuidGeneration.Fast:
                    return GenerateTimeBasedGuid(DateTimePrecise.UtcNowOffset, ClockSequenceBytes, NodeBytes);

                case GuidGeneration.NoDuplicates:
                default:
                    lock (Lock)
                    {
                        var ts = DateTimePrecise.UtcNowOffset;
