...
DETAILS:
When you install this package, a new item will appear in your Visual Studio 2012 solution templates called "VHA Service Foundation Application".  
When you creates a solution using this template, all projects (layers) of your solution with correct references and code generation templates will be 
added to your solution automatically.
